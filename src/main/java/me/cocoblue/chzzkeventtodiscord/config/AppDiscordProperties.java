...
/**
 * {@code AppDiscordProperties}는 Spring 설정 값을 바인딩합니다.
 *
...
public class AppDiscordProperties {
  private List<String> webhookAllowedHosts =
      new ArrayList<>(List.of("discord.com", "discordapp.com"));
}
