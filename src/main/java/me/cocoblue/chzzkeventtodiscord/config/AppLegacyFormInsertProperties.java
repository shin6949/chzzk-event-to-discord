...
/**
 * {@code AppLegacyFormInsertProperties}는 Spring 설정 값을 바인딩합니다.
 *
...
@Data
@Component
@ConfigurationProperties(prefix = "app.legacy-form-insert")
public class AppLegacyFormInsertProperties {
