...
CREATE TABLE discord_bot_profile_data (
  id                  DECIMAL(38)     GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
...
CREATE TABLE notification_log (
  log_id      DECIMAL(38)     GENERATED BY DEFAULT ON NULL AS IDENTITY PRIMARY KEY,
  form_id     DECIMAL(38)     NOT NULL,
  created_at  TIMESTAMP       NOT NULL
);

ALTER TABLE chzzk_channel ADD (my_temp_column TIMESTAMP WITH TIME ZONE);
UPDATE chzzk_channel SET my_temp_column = FROM_TZ(CAST(last_check_time AS TIMESTAMP), 'Asia/Seoul') WHERE last_check_time IS NOT NULL;
ALTER TABLE chzzk_channel DROP COLUMN last_check_time;
ALTER TABLE chzzk_channel RENAME COLUMN my_temp_column TO last_check_time;

ALTER TABLE chzzk_category ADD (my_temp_column TIMESTAMP WITH TIME ZONE);
UPDATE chzzk_category SET my_temp_column = FROM_TZ(CAST(updated_at AS TIMESTAMP), 'Asia/Seoul') WHERE updated_at IS NOT NULL;
ALTER TABLE chzzk_category DROP COLUMN updated_at;
ALTER TABLE chzzk_category RENAME COLUMN my_temp_column TO updated_at;

ALTER TABLE chzzk_subscription_form ADD (my_temp_column TIMESTAMP WITH TIME ZONE);
UPDATE chzzk_subscription_form SET my_temp_column = FROM_TZ(CAST(created_at AS TIMESTAMP), 'Asia/Seoul') WHERE created_at IS NOT NULL;
ALTER TABLE chzzk_subscription_form DROP COLUMN created_at;
ALTER TABLE chzzk_subscription_form RENAME COLUMN my_temp_column TO created_at;

ALTER TABLE notification_log ADD (my_temp_column TIMESTAMP WITH TIME ZONE);
UPDATE notification_log SET my_temp_column = FROM_TZ(CAST(created_at AS TIMESTAMP), 'Asia/Seoul') WHERE created_at IS NOT NULL;
ALTER TABLE notification_log DROP COLUMN created_at;
ALTER TABLE notification_log RENAME COLUMN my_temp_column TO created_at;
